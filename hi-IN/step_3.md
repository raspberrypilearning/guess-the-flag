...
\--- task \--- Click on the Code tab. There is a list called `flags`{:class="block3variables"}, where you store the names of the countries that your game has flag costumes for. \--- /task \---
...
\--- task \--- Click the green flag and check that the countries appear in the list. \--- /task \---
...
![Add a block](images/add-block.png) \--- /task \---
